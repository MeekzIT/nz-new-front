  ...
  return (
    <div className={styles.container}>
      <div className={styles.block}>
        ...
        <ImagesBlock
          imageData={[
            aboutUsPagedata.image_11, aboutUsPagedata.image_12, aboutUsPagedata.image_13, aboutUsPagedata.image_14
          ]} />
      </div>
      <div className={styles.block}>
        <ImagesBlock
          imageData={[
            aboutUsPagedata.image_21, aboutUsPagedata.image_22, aboutUsPagedata.image_23, aboutUsPagedata.image_24
          ]} />
        <div>
