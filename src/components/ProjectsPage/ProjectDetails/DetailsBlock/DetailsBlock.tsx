...
const DetailsBlock = ({ data }: IDetailsBlockProps) => {
  const { title, description1, description2 } = useHookI18Projects({ data })
  ...
  return (
    <div className={styles.container}>
      <div className={styles.block}>
        ...
        <ImagesBlock imageData={[data.image_11, data.image_12, data.image_13, data.image_14]} />
      </div>
      <div className={styles.block}>
        <ImagesBlock imageData={[data.image_21, data.image_22, data.image_23, data.image_24]} />
        <div>
